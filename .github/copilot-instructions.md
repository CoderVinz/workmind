...
- **Wiki filing** follows `wiki/references/engineering-conventions.md` (the routing table). The machine router is `scripts/wiki-mode.py` — keep it consistent with that doc.
