...
```bash
# Codex CLI
ln -s "$(pwd)/skills" ~/.codex/skills/tablinum

# OpenCode
ln -s "$(pwd)/skills" ~/.opencode/skills/tablinum
```
...
- Plugin homepage (public canonical): https://github.com/AgriciDaniel/tablinum
